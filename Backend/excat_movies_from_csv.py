...
def csv_to_mongo():
    ...
    url = r"C:\Users\shagu\Desktop\micro_move_rec\micro_move_rec\Backend\tmdb_5000_movies.csv"
    ...
    url =r"C:\Users\shagu\Desktop\micro_move_rec\micro_move_rec\Backend\tmdb_5000_credits.csv"
    data, data_dict = fetch_csv_to_data_dict(url)
    print (len(data_dict))
    for item in data_dict:
        print(item.keys())
